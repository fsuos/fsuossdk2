...
j2 --customize customization.py template/ModbusTemplate_interface.h Config/$1.yml -o Projects/$1_interface.h
j2 --customize customization.py template/ModbusTemplate.h Config/$1.yml -o Projects/$1.h
j2 --customize customization.py template/ModbusTemplate.cpp Config/$1.yml -o Projects/$1.cpp
